// client directive because this component is going to interact with the user and UI
'use client';
                        ...
                        <MenubarItem
                            ...
                            onClick={() => {
                                ...
                                if (item.value !== 'system') {
                                    ...
                                    localStorage.removeItem('theme'); // removing because we will take the value from user's device
                                }
                            }}
